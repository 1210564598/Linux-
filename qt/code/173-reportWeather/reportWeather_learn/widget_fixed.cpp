    ...
    , ui(new Ui::Widget)
{
    ...
    mTypeMap.insert("暴雨",":/res/type/BaoYu.png");              /* BUG FIXED: 原为 "BaoYu. png" 多一个空格 */
...
void Widget::on_pushButton_clicked()  /* BUG FIXED: 原为 void Widget::Widget::on_pushButton_clicked() 重复作用域 */
{
